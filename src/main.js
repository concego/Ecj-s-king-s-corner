...
function renderGame() {
  ...
  const mobileControls = `<details open class="mobile-accordion mobile-controls"><summary>${escapeHtml(t('controlsSection'))}</summary><div class="mobile-control-list">${button(t('menu'), 'back-menu', 'class="secondary" aria-keyshortcuts="Escape"')}${button(t('help'), 'menu-help', 'class="secondary" aria-keyshortcuts="H"')}${button(t('undo'), 'undo', 'class="secondary" aria-keyshortcuts="Control+Z"')}</div></details>`;
